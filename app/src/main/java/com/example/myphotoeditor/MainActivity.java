...
//                ImagePicker.Companion.with(MainActivity.this).crop().start(); //from Image picker Library of Dhaval(Used to pick image from Gallery/Camera and crop it)
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) { //from Image picker Library of Dhaval, it'll run as soon as we pick image form gallery or camera(we have called startActivityForResult above)
